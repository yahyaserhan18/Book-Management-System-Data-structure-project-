...
public:
	...
	clsDate(string sDate)
	{
		...
		vector <string> vDate;
		vDate = clsString::splitStringToVector(sDate, "/");
	...
	static string GetSystemTime(string delim = ":") {
		return GetSystemHour() + delim + GetSystemMinute() + delim + GetSystemSecond();
	}
};
